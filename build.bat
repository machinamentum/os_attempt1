...
%TOOLCHAIN%\i686-elf-gcc -c src\string.cpp       -o string.o       %COMMON_FLAGS%         || EXIT /B 1

%TOOLCHAIN%\i686-elf-ld -T linker.ld -o myos.bin -O2 -static -nostdlib boot.o main.o interrupts.o vga.o heap.o ide.o vmware_svga2.o nuklear.o math.o print.o string.o                        || EXIT /B 1
